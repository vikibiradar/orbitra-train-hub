                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      <Card className="ps-card">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">Employees awaiting planner</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="ps-card">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">Planners in draft state</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="ps-card">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">Awaiting TI approval</p>
                        </CardContent>
                      </Card>
                    </div>
