        ...
        <div className="flex flex-1 w-full">
          ...
          <SidebarInset className="flex flex-col">
            <main className="flex-1 space-y-6 p-6">
              ...
              <Card className="animate-fade-in">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <SourcePlannerSelector selectedPlanner={selectedSourcePlanner} onPlannerSelect={setSelectedSourcePlanner} />

                    {/* Employee Type Selection */}
                    <EmployeeTypeSelector employeeType={employeeType} onEmployeeTypeChange={type => {
                    ...
                    {employeeType && <TargetEmployeeSelector employeeType={employeeType} selectedEmployeeId={selectedEmployeeId} onEmployeeSelect={setSelectedEmployeeId} />}
                  </div>
              ...
              {showPlannerDetails && selectedSourcePlanner && <div className="space-y-4 animate-fade-in">
                  <PlannerTopicsDisplay planner={selectedSourcePlanner} />

                  {/* Copy Planner Button - Only visible when planner details are shown */}
                  <div className="flex justify-end">
                    <Button onClick={handleCopyPlanner} disabled={isProcessing || !selectedEmployeeId} className="min-w-[200px]">
