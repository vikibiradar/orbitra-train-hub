...
export function TopHeader() {
  return (
    <header className="sticky top-0 z-50 h-[72px] border-b bg-gradient-to-r from-ps-primary-dark to-ps-primary backdrop-blur-sm px-4 flex items-center justify-between w-full">
